...
def parse_args():
    parser = argparse.ArgumentParser(
        prog="prep_reference.py",
        description="writes a dna-safe fasta file",
    )
    parser.add_argument(
        "-f",
        "--fasta",
        metavar="FASTA_FILE",
        help="fasta file to check",
        type=str,
        required=True,
    )
    parser.add_argument(
        ...
        "--out",
        metavar="FASTA_FILE",
        help="dna-safe fasta file to write (exisiting file will be overwritten!)",
        type=str,
        required=True,
    )
    parser.add_argument(
        ...
        "--len",
        metavar="INT",
        help="sequence line length (set 0 to avoid new lines, default=60)",
        type=int,
        default=60,
    )
