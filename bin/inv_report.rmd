...
dt.bamstats_coverage <- dt.bamstats_coverage[, c(
  "sample", "reads mapped [%].HA", "coverage [%].HA", "mean depth [bp].HA",
...
df.top.refs.reshaped %>%
  ...
  add_header_above(c("Sample", "Reference Hit",
    "HA" = 1, "NA" = 1, "MP" = 1, "NP" = 1,
